...
import cn.dozyx.template.view.anim.searce.SearchVectorAnimFragment
...
class AnimatorPagerActivity : BaseActivity() {
    ...
    private fun setupPager() {
        val fragments = arrayOf(FragmentWrapper("搜索", SearchVectorAnimFragment()), FragmentWrapper("Vector动画", VectorAnimFragment()), FragmentWrapper("支付成功", PaySuccessFragment()), FragmentWrapper("带箭头转圈", ArrowCircleFragment()), FragmentWrapper("转圈", LoadingAnimatorFragment()), FragmentWrapper("响铃", BellAnimatorFragment()), FragmentWrapper("菜单", ExpandMenuFragment()))
